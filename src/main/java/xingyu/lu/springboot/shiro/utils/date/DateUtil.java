package xingyu.lu.springboot.shiro.utils.date;
...
public class DateUtil {
    ...
    public static final String DATE_FORMAT_6 = "yy-MM-dd HH:mm";
     ...
     * @date 18/11/21 13:27
     */
    public static boolean nullEquals(Date d1, Date d2) {
        if (d1 == null && d2 == null) {
            return true;
        }
        if (d1 == null || d2 == null) {
    ...
    public static Date getTodayZeroClock() {
        return parseStrToDate(getNowDateStr(DATE_FORMAT_2), DATE_FORMAT_2);
    }
